...
class Reseau {
	public :
		...
		//AUTRE METHODE PUBLIQUE________________________________________
				/*!
		 ...
		 */
		void evolue(int pasInitial, int pasFinal, double Iext, bool poisson);
	private :
		...
		std::vector<int> tableauAImprimer;								///< tableau pour pics totaux par pas de temps
